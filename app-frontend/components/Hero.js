        ...
        >
          <div className="bg-black/45 flex items-center justify-center inset-0 absolute p-8 md:p-12 lg:px-16 lg:py-24">
            <div className="text-center">
              ...
              <p className=" max-w-2xl mx-auto text-white/90 max-sm:my-3 md:mt-6 md:block  md:text-lg leading-relaxed">
              ...
              <div className="mt-4 sm:mt-8 max-sm:mt-8">
                <Link
                  href={"/products"}
          ...
          <div className="lg:py-40 min-h-[650px]">
            <div className="relative mx-auto sm:static px-6 lg:px-8 ">
              <div className="max-w-xl text-start">
                ...
                <div className="flex max-sm:flex-col gap-4 mt-10 items-center max-sm:justify-center max-sm:mt-6">
                  ...
                  <div className="max-sm:flex max-sm:space-x-3">
                  <Link
